...
export default function Body(){
    return(
        <div className="items-center justify-center h-147.25 w-full flex flex-col">
            ...
            <Link href="/product" className={`${inter.className} text-white text-[20px] font-semibold leading-[130%] font-features-['liga'_off,'clig'_off] px-8 py-4.75 bg-[#426B1F] inline-flex rounded-xl mt-12`}>
