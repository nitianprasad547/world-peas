...
export default function Navbar(){
    return(
        <div className="w-full mb-14 flex flex-row justify-between">
            <div className="flex flex-row font-features-['liga'_off,'clig'_off] w-[41.32%] justify-between">
                <h1 className={`${newsreader.className} text-black items-center text-center text-[64px] font-normal leading-[120%] tracking-[-1.28px] mt-14 mx-[13.334%]`}>Produce</h1>
