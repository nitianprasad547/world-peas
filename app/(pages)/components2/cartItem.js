...
export default function Cart({ name, src, price, place }) {
    const image = src;
    return (
        <div className={`${inter.className}w-full h-111 flex-wrap flex flex-col rounded-3xl text-black mb-10 overflow-hidden border border-[#E6E6E6] border-solid bg-[#FAFAF5]`}>
